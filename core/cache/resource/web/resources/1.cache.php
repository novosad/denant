<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p style="text-indent: 10px;">ООО «ДенАнтТранс» — транспортно-экспедиционная компания. Наша компания успешно осуществляет свою деятельность на рынке международных грузоперевозок. Штат квалифицированных специалистов предлагает вам свои услуги в организации международных перевозок грузов любой сложности собственным и привлеченным автомобильным транспортом.</p>
<p style="text-indent: 10px;">Направления нашей постоянной работы — транспортировка и экспедирования грузов из Беларуси в Россию, Казахстан, Украину, Венгрию, Сербию, Польшу, Чехию, Словакию, Хорватию, Германию, Голландию, Италию, Литву, Латвию, Эстонию и в обратном направлении.</p>
<p style="text-indent: 10px;">Наша компания предоставляет услуги по доставке сборных грузов от 100 кг и более, грузов АДР класса, негабаритных грузов по вышеуказанным направлениям.</p>
<p style="text-indent: 10px;">За время своей работы на рынке транспортных услуг, наша компания приобрела широкий круг партнёров и богатый опыт в транспортно-экспедиционном обслуживании самых различных видов грузов. Быстрота доставки, надёжность и удобство работы с нами, дополнительные сервисы, которые предоставляет наша компания — благодаря всему этому множество предприятий являются нашими постоянными клиентами.</p>
<p style="text-indent: 10px;">Приглашаем к сотрудничеству!</p>',
    'richtext' => 1,
    'template' => 2,
    'menuindex' => 0,
    'searchable' => 1,
...
<a href="http://denant.loc/en/en-index.html" class="en">en</a>
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <h1> О компании </h1>
            <div class="wrap">
                <p style="text-indent: 10px;">ООО «ДенАнтТранс» — транспортно-экспедиционная компания. Наша компания успешно осуществляет свою деятельность на рынке международных грузоперевозок. Штат квалифицированных специалистов предлагает вам свои услуги в организации международных перевозок грузов любой сложности собственным и привлеченным автомобильным транспортом.</p>
<p style="text-indent: 10px;">Направления нашей постоянной работы — транспортировка и экспедирования грузов из Беларуси в Россию, Казахстан, Украину, Венгрию, Сербию, Польшу, Чехию, Словакию, Хорватию, Германию, Голландию, Италию, Литву, Латвию, Эстонию и в обратном направлении.</p>
<p style="text-indent: 10px;">Наша компания предоставляет услуги по доставке сборных грузов от 100 кг и более, грузов АДР класса, негабаритных грузов по вышеуказанным направлениям.</p>
<p style="text-indent: 10px;">За время своей работы на рынке транспортных услуг, наша компания приобрела широкий круг партнёров и богатый опыт в транспортно-экспедиционном обслуживании самых различных видов грузов. Быстрота доставки, надёжность и удобство работы с нами, дополнительные сервисы, которые предоставляет наша компания — благодаря всему этому множество предприятий являются нашими постоянными клиентами.</p>
<p style="text-indent: 10px;">Приглашаем к сотрудничеству!</p>

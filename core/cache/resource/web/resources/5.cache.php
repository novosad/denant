<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h2>Перевозка негабаритных грузов</h2>
<p>Перевозка негабаритных грузов - это сложная и ответственная задача. Доверьте ее профессионалам!</p>
<h2>Перевозка сборных грузов</h2>
<p>Если Вам требуется перевозка сборных грузов , Вы можете связаться с нашими сотрудниками</p>
<h2>Проектные перевозки грузов</h2>
<p>Проектные перевозки - от доставки крупной партии оборудования, до переезда предприятия или завода.</p>
<h2>Контейнерные перевозки грузов</h2>
<p>Контейнерные грузоперевозки - идеальное решение для доставки груза на большое расстояние.</p>
<h2>Рефрижераторные перевозки грузов</h2>
<p>Наш транспорт своевременно проходит надлежащее техническое обслуживание и санитарную обработку.</p>
<h2>Перевозка опасных грузов</h2>
<p>Компания обладает всеми необходимыми разрешениями на перевозку опасных грузов.</p>',
    'richtext' => 1,
    'template' => 2,
    'menuindex' => 2,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1441696039,
    'editedby' => 1,
    'editedon' => 1441867004,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1441696020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div class="main">
  <div class="header">
    ...
    [[!Wayfinder? &startId=`0`]]
      ...
      <div class="logo">
    <div class="lang">
    <a href="http://denant.loc/services.html" class="ru">ru</a>
<a href="http://denant.loc/en/en-services.html" class="en">en</a>
</div>
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <h1> Услуги </h1>
            <div class="wrap">
                <h2>Перевозка негабаритных грузов</h2>
<p>Перевозка негабаритных грузов - это сложная и ответственная задача. Доверьте ее профессионалам!</p>
<h2>Перевозка сборных грузов</h2>
<p>Если Вам требуется перевозка сборных грузов , Вы можете связаться с нашими сотрудниками</p>
<h2>Проектные перевозки грузов</h2>
...
<![endif]-->',
    ...
    '[[BabelLinks? &tpl=`language` &showCurrent=`1` &ignoreSiteStatus=`1`]]' => '<a href="http://denant.loc/services.html" class="ru">ru</a>
<a href="http://denant.loc/en/en-services.html" class="en">en</a>',
    '[[$lang]]' => '<div class="lang">
    <a href="http://denant.loc/services.html" class="ru">ru</a>
<a href="http://denant.loc/en/en-services.html" class="en">en</a>
